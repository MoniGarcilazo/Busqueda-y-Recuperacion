...
$insert_document_template = "INSERT INTO documents (name_doc, creation_date, url_doc, description_doc, texto_archivo) 
                    VALUES (:name_doc, :creation_date, :url_doc, :description_doc, :texto_archivo)";
